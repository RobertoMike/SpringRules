 ...
 * @see [rgbLegacyRegex]
 */
const val rgbLegacyRegex = "^rgb\\(\\s?((?:1?\\d{1,2}|2[0-4]\\d|25[0-5])\\s?,\\s?){2}(?:1?\\d{1,2}|2[0-4]\\d|25[0-5])\\s?\\)\$|^rgba\\(\\s?((?:1?\\d{1,2}|2[0-4]\\d|25[0-5])\\s?,\\s?){2}(?:1?\\d{1,2}|2[0-4]\\d|25[0-5])\\s?,\\s?(0|1|0?\\.\\d+)\\s?\\)\$"
/**
 ...
 * @see [rgbRegex]
 */
const val rgbRegex = "^rgba?\\(\\s*(?:(?:(?:1?\\d{1,2}|2[0-4]\\d|25[0-5])\\s+){2}(?:1?\\d{1,2}|2[0-4]\\d|25[0-5])(?:\\s*\\/\\s*(?:0?\\.?\\d+|1|0))?)\\s*\\)\$"
